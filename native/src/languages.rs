...
pub struct LanguageDefinition {
    ...
    /// Nodes that add a cyclomatic path but no cognitive point or nesting level.
    pub cyclomatic_only_node_types: &'static [&'static str],
...
pub const LANGUAGES: &[LanguageDefinition] = &[
    ...
    LanguageDefinition {
        ...
        // PMD's standard cyclomatic complexity charges `throw` one path (verified against PMD
        // 7.26.0); other languages follow lizard/radon, which do not count throw/raise.
        cyclomatic_only_node_types: &["throw_statement"],
