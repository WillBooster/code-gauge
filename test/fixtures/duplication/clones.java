public class Clones {
  ...
  static double summarizeOrders(int[] amounts, boolean[] flags) {
    double total = 0;
    int count = 0;
  ...
  static double summarizeRefunds(int[] values, boolean[] marks) {
    double sum = 0;
    int seen = 0;
  ...
  static int priceTableAlpha(int index) {
    int[] values = {101, 202, 303, 404, 505, 606, 707, 808, 909, 1010, 1111, 1212, 1313, 1414, 1515, 1616, 1717, 1818, 1919, 2020};
    return values[index];
  }

  static int priceTableBeta(int index) {
    int[] values = {111, 222, 333, 444, 555, 666, 777, 888, 999, 1101, 1202, 1303, 1404, 1505, 1606, 1707, 1808, 1909, 2101, 2202};
    return values[index];
  }
}
